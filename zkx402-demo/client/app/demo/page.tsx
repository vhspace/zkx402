          ...
          {showExplanation && (
            <div className="expanded-content">
              ...
              <ol>
                ...
                <li>
                  <strong>
                    client makes request to <code>/motivate</code> endpoint
                  </strong>
                  <pre
                    style={{
                      fontSize: '12px',
                  ...
                  <details style={{ marginTop: '8px' }}>
                    ...
                    >
                      ...
                      <ul style={{ marginLeft: '20px', marginTop: '8px' }}>
                        ...
                        <li>
                          adds <code>validBefore</code> timestamp (expiration)
                        </li>
                        <li>
                          generates unique <code>nonce</code> (prevents replay
                          attacks)
                        </li>
                        <li>signs with your CDP Embedded Wallet private key</li>
                        <li>
                          no gas needed - facilitator sponsors the transaction
                        </li>
                      </ul>
                    </div>
                  </details>
